...
export const cateringPackages: CateringPackage[] = [
  {
    ...
    sections: [
      ...
      { heading: 'Meat Curry', note: 'Choose one of the following', options: ['Chicken Qorma', 'Chicken Karahi', 'Veal Qorma (add $1)'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Meat Curry', note: 'Choose one of the following', options: ['Chicken Qorma', 'Chicken Karahi', 'Veal Qorma (add $1)', 'Achar Chicken (Min. 50 ppl)'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Raita', options: ['Yogurt sauce with herbs'] },
      { heading: 'Naans', options: ['Afghani naans', 'Tandoori (add $1)'] },
      { heading: 'Dessert', note: 'Choose one of the following', options: ['Kheer', 'Gulab Jaman', 'Carrot Halwa (add $1)', 'Mango Delight (add $1)', 'Zarda (Min. 50 ppl) (add $1)'] },
    ],
  },
  {
    id: 'platinum',
