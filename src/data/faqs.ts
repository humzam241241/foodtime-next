export const faqs = [
  { question: 'What are your hours of operation?', answer: 'We are closed on Mondays.<br/>Tuesday to Friday: 11 AM to 10 PM<br/>Saturday: 10 AM to 10 PM<br/>Sunday: 10 AM to 9 PM<br/><em>Please Note: Dine-in closes 1 hour before closing time.</em>' },
  { question: 'Does Food Time have any other locations?', answer: 'Yes, we have two locations in Pickering & Whitby.' },
  { question: 'What is the best way to place an order?', answer: "It's easy! Just call us and we'll have it hot and ready for you." },
